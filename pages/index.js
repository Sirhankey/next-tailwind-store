...
import { getProducts } from '../utils/ProductService.ts';
...
export default function Home() {
  ...
  return (
    <div className="datatable-crud-demo surface-card p-4 border-round shadow-2">
      ...
      <div className="text-3xl text-800 font-bold mb-4">Venda de Garagem online</div>
      ...
      <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
        ...
        <Column field="price" header="Preço" body={priceBodyTemplate} sortable style={{ minWidth: '8rem' }}></Column>
        ...
        <Column field="inventoryStatus" header="Disponível" body={statusBodyTemplate} sortable style={{ minWidth: '12rem' }}></Column>
        <Column body={actionBodyTemplate} exportable={false} style={{ minWidth: '8rem' }}></Column>
      </DataTable>

      <Dialog visible={productDialog} breakpoints={{ '960px': '75vw', '640px': '100vw' }} style={{ width: '40vw' }} header="Adicionar Item para Venda" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
        ...
        <div className="field">
          ...
          <div className="formgrid grid">
            <div className="field-radiobutton col-6">
              <RadioButton inputId="category1" name="category" value="Moveis" onChange={onCategoryChange} checked={product.category === 'Moveis'} />
              <label htmlFor="category1">Móveis</label>
            </div>
            <div className="field-radiobutton col-6">
              <RadioButton inputId="category2" name="category" value="Eletronicos" onChange={onCategoryChange} checked={product.category === 'Eletronicos'} />
              <label htmlFor="category2">Eletrônicos</label>
            </div>
            <div className="field-radiobutton col-6">
              <RadioButton inputId="category3" name="category" value="Cozinha" onChange={onCategoryChange} checked={product.category === 'Cozinha'} />
              <label htmlFor="category3">Cozinha</label>
            </div>
            <div className="field-radiobutton col-6">
              <RadioButton inputId="category4" name="category" value="CamaMesaBanho" onChange={onCategoryChange} checked={product.category === 'CamaMesaBanho'} />
